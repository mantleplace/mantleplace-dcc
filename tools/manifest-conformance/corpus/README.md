...
`manifest.foliageVocabularyIgnored` the second, `manifest.hostFramesIgnored` the third and
`manifest.hazardLayersIgnored` the fourth. Stamping a newer version onto a fixture that lacks what
